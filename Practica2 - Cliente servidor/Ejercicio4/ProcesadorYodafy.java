...
public class ProcesadorYodafy {
    ...
    public void procesar(){
		...
		try {
            ...
            //while(!socketServicio.isConnected()){};
            socketServicio.receive(paquete);
			// Lee la frase a Yodaficar:
			////////////////////////////////////////////////////////
			// read ... datosRecibidos.. (Completar)
			////////////////////////////////////////////////////////
			//bytesRecibidos = inputStream.read(datosRecibidos,0,1024);
            ...
            DatagramPacket envio = new DatagramPacket(datosEnviar,datosEnviar.length,paquete.getAddress(),paquete.getPort());
            socket.send(envio);
